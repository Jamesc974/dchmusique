...
const commands = {
	...
	'join': (msg) => {
		return new Promise((resolve, reject) => {
			...
			if (!voiceChannel || voiceChannel.type !== 'voice') return msg.reply(':disappointed_relieved: Je ne peux pas me connecter à votre Channel');
...
client.on("ready", async () => {
  ...
  client.user.setPresence({ game: { name: `[!dchbot] || connecté à ${client.guilds.size} serveur || créé par TarKyo et DCH`}})
